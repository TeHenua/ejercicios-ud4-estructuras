        ...
        do {
            ...
            switch (opcion){
                ...
                case 2:
                    ...
                    Asignatura as = new Asignatura(nombreA,horas);
                    asignaturas.add(as);
                    break;
                case 3:
                ...
                case 5:
                    ...
                    int alumInt = elegirAlumno(alumnos, br);
                    System.out.println("Asignaturas en las que está matriculado "+alumnos.get(alumInt).getNombre()+" "+alumnos.get(alumInt).getApellidos());
                    int totalHoras=0;
                    for(Asignatura asignat: alumnos.get(alumInt).getAsignaturas()){
